...
const expectedDualSpecDirs = [
  ...
  "contracts/spec",
  "core/domain_exchange/spec",
  "core/domain_macro/spec",
  "core/domain_market/spec",
  "core/domainx/spec",
  ...
  "kernel/spec",
  "macro_data/bea/spec",
  "macro_data/eastmoney/spec",
  "macro_data/ecb/spec",
  "macro_data/fred/spec",
  "macro_data/japan_cb/spec",
  "macro_data/jin10/spec",
  "macro_data/treasury/spec",
  "macro_data/uk_cb/spec",
  "macro_data/yahoo/spec",
  "macro_data/yield_curve/spec",
  "market_data/binance/spec",
  "market_data/coinbase/spec",
  "market_data/coinglass/spec",
  "market_data/hyperliquid/spec",
  "market_data/okx/spec",
  "market_data/orderbook/spec",
  "testkit/spec",
  "tools/goalctl/spec",
...
function runGate(root) {
  ...
  const currentStateRules = [
    ...
    },
    {
      ...
      required: ["`crates/infra/evidence/`", "gate 为 OOS"],
  ...
  const implementationSurfaceRules = [
    ["crates/infra/configx/src/source.rs", ["pub struct MemorySource", "pub struct EnvSource", "pub struct FileSource"]],
    ["crates/infra/configx/src/layered.rs", ["pub struct LayeredConfig", "#[cfg(test)]"]],
    ["crates/infra/configx/src/watch.rs", ["pub struct ConfigWatch", "#[cfg(test)]"]],
    ["crates/infra/configx/src/secret.rs", ["pub struct SecretString", "#[cfg(test)]"]],
    ["crates/infra/schedulex/src/runner.rs", ["pub struct JobRunner", "pub fn tick", "#[cfg(test)]"]],
