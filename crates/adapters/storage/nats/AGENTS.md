...
> 适用 crate：`crates/adapters/storage/nats/`（包名 `natsx`）  
> 父级规则：[`crates/AGENTS.md`](../../../AGENTS.md)  
> SSOT 镜像：[`.agents/ssot/adapters/storage/nats`](../../../../.agents/ssot/adapters/storage/nats/)  
...
nats storage adapter（当前为 scaffold）。
