...
fn from_env_respects_overrides() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HOST", "ch2.example.com");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HTTP_PORT", "9440");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_TLS", "true");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_USER", "reader");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_PASSWORD", "secret123");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_DATABASE", "analytics");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_TIMEOUT_MS", "5000");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_MAX_IDLE_PER_HOST", "4");
        }
...
fn from_env_empty_string_does_not_override() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HOST", "");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_USER", "");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_DATABASE", "");
        }
...
fn invalid_env_variables_cause_errors() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_MAX_IN_FLIGHT", "not-a-number");
        }
...
fn only_http_port_set() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HTTP_PORT", "8443");
        }
...
fn only_port_alias_set() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_PORT", "9440");
        }
        let cfg = ClickHouseConfig::from_env().expect("from_env");
        assert_eq!(cfg.http_port, 9440);
    });
...
fn port_conflict_fails() {
    with_clean_env(|| {
        unsafe {
            ...
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_PORT", "8443");
        }
...
fn from_env_full_coverage() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HOST", "ch.internal");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HTTP_PORT", "9440");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_TLS", "true");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_USER", "admin");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_PASSWORD", "p@ss");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_DATABASE", "metrics");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_TIMEOUT_MS", "6000");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_MAX_IDLE_PER_HOST", "12");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_MAX_IN_FLIGHT", "128");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_ACQUIRE_TIMEOUT_MS", "4000");
        }
...
fn from_env_invalid_number_fails() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_TIMEOUT_MS", "xyz");
        }
...
fn invalid_port_number_fails() {
    with_clean_env(|| {
        unsafe {
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_PORT", "-1");
        }
...
fn partial_env_config_validates() {
    with_clean_env(|| {
        unsafe {
            ...
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_HTTP_PORT", "9123");
            std::env::set_var("FOUNDATIONX_CLICKHOUSEX_DATABASE", "custom_db");
        }
