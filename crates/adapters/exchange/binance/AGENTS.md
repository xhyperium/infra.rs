...
> 适用 crate：`crates/adapters/exchange/binance/`（包名 `binancex`）  
> 父级规则：[`crates/AGENTS.md`](../../../AGENTS.md)  
> SSOT 镜像：[`.agents/ssot/adapters/exchange/binance`](../../../../.agents/ssot/adapters/exchange/binance/)  
...
binance exchange adapter（当前为 scaffold）。
