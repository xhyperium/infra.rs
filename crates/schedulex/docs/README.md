...
**Package**：`xhyper-schedulex` · **lib**：`schedulex` · **角色**：L1 任务 ID 登记表
...
| 本仓 SSOT 对齐 | [`docs/ssot/schedulex-ssot-alignment.md`](../../../docs/ssot/schedulex-ssot-alignment.md) |
| 上游 SSOT 镜像 | `.agents/ssot/infra/schedulex/` |
