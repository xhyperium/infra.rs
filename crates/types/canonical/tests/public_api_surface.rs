//! canonical 公开面：shape/wire/time helpers 全量。

use canonical::{
    COMMITTED_WIRE_V1, COMMITTED_WIRE_V1_1, COMMITTED_WIRE_V1_2, COMMITTED_WIRE_V1_3,
    CancelOrderRequest, InstrumentId, Order, OrderAck, OrderBookSnapshot, OrderRef, OrderStatus,
...
fn shape_and_time_and_wire_surface() {
    ...
    let _ = wire_commitment("NotAType");
    ...
    let _ = (
        ...
        OrderAck { id: "1".into(), status: OrderStatus::Filled, ts: 1 },
        Position {
            symbol: "S".into(),
            qty: Qty::new(Decimal::new(1, 0)),
        ...
        OrderBookSnapshot { symbol: "S".into(), bids: vec![], asks: vec![], ts: 0 },
        Trade {
            symbol: "S".into(),
            price: Price::new(Decimal::new(1, 0)),
            qty: Qty::new(Decimal::new(1, 0)),
