...
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 2i+u | 3462 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 3i+u | 3666 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
