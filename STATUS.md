...
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 3i+u | 3177 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 2i+u | 1914 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
