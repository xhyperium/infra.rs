...
| `kafkax` | `crates/adapters/storage/kafka` | adapter | 7/7 | ✅ 8i+u | 4642 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/kafkax-ssot-alignment.md) |
...
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 5i+u | 4635 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
