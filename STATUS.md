...
| `goalctl` | `tools/goalctl` | L1 | 7/7 | ✅ 1i+u | 536 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/tools-ssot-alignment.md) |
| `verifyctl` | `tools/verifyctl` | L1 | 7/7 | ✅ 1i+u | 634 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/tools-ssot-alignment.md) |
...
| `clickhousex` | `crates/adapters/storage/clickhouse` | adapter | 7/7 | ✅ 1i+u | 513 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/clickhousex-ssot-alignment.md) |
| `kafkax` | `crates/adapters/storage/kafka` | adapter | 7/7 | ✅ 1i+u | 1051 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/kafkax-ssot-alignment.md) |
| `natsx` | `crates/adapters/storage/nats` | adapter | 7/7 | ✅ 1i+u | 672 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/natsx-ssot-alignment.md) |
| `ossx` | `crates/adapters/storage/oss` | adapter | 7/7 | ✅ 1i+u | 698 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/ossx-ssot-alignment.md) |
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 1i+u | 1702 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 2i+u | 1516 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 1i+u | 759 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
