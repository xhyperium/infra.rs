...
|---------|------|----|:----:|:----:|----:|:----:|--------|--------|------|
| `kernel` | `crates/kernel` | L0 | 8/8 | ✅ 6i+u | 1691 | · | `active` | **98%** ████████ | [✓](docs/ssot/kernel-ssot-alignment.md) |
| `testkit` | `crates/testkit` | T0 | 8/8 | ✅ 6i+u | 577 | · | `active` | **98%** ████████ | [✓](docs/ssot/testkit-ssot-alignment.md) |
| `canonical` | `crates/types/canonical` | types | 8/8 | ✅ 2i+u | 1181 | · | `active` | **98%** ████████ | [✓](docs/ssot/types-ssot-alignment.md) |
| `decimalx` | `crates/types/decimal` | types | 8/8 | ✅ 6i+u | 1466 | · | `active` | **98%** ████████ | [✓](docs/ssot/types-ssot-alignment.md) |
...
| `evidence` | `crates/evidence` | L1 | 8/8 | ✅ 2i+u | 176 | · | `partial` | **88%** ███████░ | [✓](docs/ssot/evidence-ssot-alignment.md) |
| `observex` | `crates/observex` | L1 | 8/8 | ✅ 2i+u | 190 | · | `partial` | **88%** ███████░ | [✓](docs/ssot/observex-ssot-alignment.md) |
| `resiliencx` | `crates/resiliencx` | L1 | 8/8 | ✅ 3i+u | 919 | · | `active` | **98%** ████████ | [✓](docs/ssot/resiliencx-ssot-alignment.md) |
| `schedulex` | `crates/schedulex` | L1 | 8/8 | ✅ 2i+u | 110 | · | `partial` | **88%** ███████░ | [✓](docs/ssot/schedulex-ssot-alignment.md) |
| `transportx` | `crates/transport` | L1 | 8/8 | ✅ 4i | 417 | 1 | `active` | **95%** ████████ | [✓](docs/ssot/transport-ssot-alignment.md) |
| `contracts` | `crates/contracts` | contracts | 8/8 | ✅ 4i+u | 1119 | · | `active` | **98%** ████████ | [✓](docs/ssot/contracts-ssot-alignment.md) |
