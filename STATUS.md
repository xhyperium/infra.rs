...
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 4i+u | 5091 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 2i+u | 2527 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
