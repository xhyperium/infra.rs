...
<<<<<<< HEAD
> **生成时间**：2026-07-23T05:12:26Z
=======
> **生成时间**：2026-07-23T05:14:22Z
>>>>>>> 496e401 (test(postgresx): raw fail-closed 独立 live 证据 (0.3.8))
...
| `kafkax` | `crates/adapters/storage/kafka` | adapter | 7/7 | ✅ 3i+u | 2964 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/kafkax-ssot-alignment.md) |
...
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 2i+u | 3334 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 3i+u | 3291 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 2i+u | 2157 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
