...
| `kafkax` | `crates/adapters/storage/kafka` | adapter | 7/7 | ✅ 3i+u | 2727 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/kafkax-ssot-alignment.md) |
...
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 2i+u | 3172 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 3i+u | 3148 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 2i+u | 1841 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
