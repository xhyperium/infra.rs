...
| `testkit` | `crates/testkit` | T0 | 7/7 | ✅ 7i+u | 1235 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/testkit-ssot-alignment.md) |
...
| `configx` | `crates/configx` | L1 | 7/7 | ✅ 2i+u | 2014 | 2 | `active` | **100%** ████████ | [✓](docs/ssot/configx-ssot-alignment.md) |
...
| `clickhousex` | `crates/adapters/storage/clickhouse` | adapter | 7/7 | ✅ 3i+u | 1324 | — | `active` | **98%** ████████ | [✓](docs/ssot/clickhousex-ssot-alignment.md) |
| `kafkax` | `crates/adapters/storage/kafka` | adapter | 7/7 | ✅ 8i+u | 4842 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/kafkax-ssot-alignment.md) |
| `natsx` | `crates/adapters/storage/nats` | adapter | 7/7 | ✅ 3i+u | 3053 | 2 | `active` | **100%** ████████ | [✓](docs/ssot/natsx-ssot-alignment.md) |
| `ossx` | `crates/adapters/storage/oss` | adapter | 7/7 | ✅ 2i+u | 3887 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/ossx-ssot-alignment.md) |
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 3i+u | 5563 | 2 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 6i+u | 6119 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
| `taosx` | `crates/adapters/storage/taos` | adapter | 7/7 | ✅ 5i+u | 4788 | 3 | `active` | **100%** ████████ | [✓](docs/ssot/taosx-ssot-alignment.md) |
