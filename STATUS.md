...
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 1i+u | 2315 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 2i+u | 2478 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
