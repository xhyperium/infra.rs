...
|---------|------|----|:----:|:----:|----:|:----:|--------|--------|------|
| `kernel` | `crates/kernel` | L0 | 7/7 | ✅ 6i+u | 1691 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/kernel-ssot-alignment.md) |
...
| `decimalx` | `crates/types/decimal` | types | 7/7 | ✅ 6i+u | 1466 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/types-ssot-alignment.md) |
| `bootstrap` | `crates/bootstrap` | L1 | 7/7 | ✅ 2i+u | 1020 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/bootstrap-ssot-alignment.md) |
| `configx` | `crates/configx` | L1 | 7/7 | ✅ 2i+u | 191 | 1 | `partial` | **90%** ███████░ | [✓](docs/ssot/configx-ssot-alignment.md) |
| `evidence` | `crates/evidence` | L1 | 7/7 | ✅ 2i+u | 176 | · | `partial` | **88%** ███████░ | [✓](docs/ssot/evidence-ssot-alignment.md) |
| `observex` | `crates/observex` | L1 | 7/7 | ✅ 2i+u | 190 | · | `partial` | **88%** ███████░ | [✓](docs/ssot/observex-ssot-alignment.md) |
| `resiliencx` | `crates/resiliencx` | L1 | 7/7 | ✅ 3i+u | 919 | · | `active` | **98%** ████████ | [✓](docs/ssot/resiliencx-ssot-alignment.md) |
| `schedulex` | `crates/schedulex` | L1 | 7/7 | ✅ 2i+u | 110 | · | `partial` | **88%** ███████░ | [✓](docs/ssot/schedulex-ssot-alignment.md) |
| `transportx` | `crates/transport` | L1 | 7/7 | ✅ 4i | 417 | 1 | `active` | **95%** ████████ | [✓](docs/ssot/transport-ssot-alignment.md) |
| `contracts` | `crates/contracts` | contracts | 7/7 | ✅ 4i+u | 1119 | · | `active` | **98%** ████████ | [✓](docs/ssot/contracts-ssot-alignment.md) |
