...
| `postgresx` | `crates/adapters/storage/postgres` | adapter | 7/7 | ✅ 1i+u | 1967 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/postgresx-ssot-alignment.md) |
| `redisx` | `crates/adapters/storage/redis` | adapter | 7/7 | ✅ 2i+u | 1807 | 1 | `active` | **100%** ████████ | [✓](docs/ssot/redisx-ssot-alignment.md) |
