...
| 计划 | 状态 | 说明 |
|------|------|------|
| [2026-07-24-crates-infra-directory-migration.md](./2026-07-24-crates-infra-directory-migration.md) | **IMPLEMENTED · 待合并**（`chore/infra-dir-layout`） | 方案 A：L1 七包迁入 `crates/infra/`（纯路径；单 PR 原子）；依据 [归组分析](../report/2026-07-24/crates-infra-grouping-analysis.md) |
