...
| `redisx` | `crates/adapters/storage/redis/` | `redisx` | **0.3.12** Standalone P0+ + selfcheck §6.5 + live/E2E；Cluster/Sentinel/TLS live OPEN | [redisx-ssot-alignment.md](./redisx-ssot-alignment.md) · [adapters-ssot-alignment.md](./adapters-ssot-alignment.md) |
