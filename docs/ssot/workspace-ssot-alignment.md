...
| `taosx` | `crates/adapters/storage/taos/` | `taosx` | **0.3.5** REST/NCHAR + BatchWriteReport + WS 探测 + 真实 live + 十轮矩阵；幂等重试/package stable NO-GO | [taosx-ssot-alignment.md](./taosx-ssot-alignment.md) · [adapters-ssot-alignment.md](./adapters-ssot-alignment.md) |
