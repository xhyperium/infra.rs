...
| `.agents/ssot/adapters/storage/postgres` | `crates/adapters/storage/postgres` | `postgresx` | **`0.3.9`** Pool/Tx/Repository + acquire_with + 有界 COPY；远程 TLS live；mTLS/package stable OPEN |
