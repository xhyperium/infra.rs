...
for d in market_data/binance market_data/okx \
  storage/clickhouse storage/kafka storage/nats storage/oss \
  storage/postgres storage/redis storage/taos; do
  base=".agents/ssot/adapters"
  case $d in market_data/*) base=".agents/ssot";; esac
  cmp $base/$d/spec/spec.md \
      $base/$d/spec/xhyper-*-complete-spec.md
done
