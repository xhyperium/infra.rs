...
| `.agents/ssot/adapters/storage/postgres` | `crates/adapters/storage/postgres` | `postgresx` | **`0.3.10`** Pool/Tx/Repository + acquire_with + 有界 COPY + mTLS 客户端身份；远程 TLS live；package stable OPEN |
