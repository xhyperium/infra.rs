...
| `.agents/ssot/adapters/storage/redis` | `crates/adapters/storage/redis` | `redisx` | **`0.3.13`** Standalone P0+ KV/pipeline/锁/metrics/selfcheck + live 矩阵 + data E2E soft-skip；Cluster/Sentinel/TLS live OPEN；package stable 禁止宣称 |
