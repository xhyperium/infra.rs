...
| `.agents/ssot/adapters/storage/redis` | `crates/adapters/storage/redis` | `redisx` | **`0.3.13`** 全公开 API（KV/结构/Streams/事务/锁/selfcheck）+ live/E2E/bench；Cluster/Sentinel/TLS live 环境 OPEN；package stable 禁止宣称 |
