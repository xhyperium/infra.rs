...
| `.agents/ssot/adapters/storage/postgres` | `crates/adapters/storage/postgres` | `postgresx` | **`0.3.8`** Pool/Tx/Repository + 远程 Require live（CA+SNI）；dev/remote live 9/9 + deadline；mTLS/package stable OPEN |
