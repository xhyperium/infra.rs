...
| `.agents/ssot/adapters/storage/taos` | `crates/adapters/storage/taos` | `taosx` | **`0.3.7`** REST + BatchWriteReport + metrics + health/readiness + Native WS 握手 live；幂等/HA/package stable NO-GO |
验证（本仓权威命令）：
