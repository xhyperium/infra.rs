...
| 审计日期 | 2026-07-22 |
| version | `0.3.2` |
| 结论 | **AMO、单 owner 应用 ALO、TLS+CA+SASL/PLAIN 有 broker 证据**；group/rebalance/native EOS **NO-GO**；未宣称 package stable |
...
| 内部 deadline | PASS | connect/metadata/topic/partition client 均有界 |
