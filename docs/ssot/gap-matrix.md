...
| postgresx | Pool+query+tx+TLS | **done** + Repository + 远程 Require live（CA+SNI）+ deadline + dev/remote live 9/9 (`0.3.8`) | mTLS / COPY / migrations / read-replica / package stable |
