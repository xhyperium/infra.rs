...
| postgresx | Pool+query+tx+TLS | **done** + Repository + 远程 Require live（CA+SNI）+ deadline + dev live 10/10 + remote TLS 9/9 (`0.3.9`) | mTLS / 无限流式 COPY / migrations / read-replica / package stable |
