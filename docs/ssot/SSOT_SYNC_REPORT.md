...
| adapters 九域 | `crates/adapters/**` | **storage×7 生产默认路径** + live/bench（#188–#190）；exchange scaffold + public time | [adapters-ssot-alignment.md](./adapters-ssot-alignment.md) |
...
> 镜像 COMPLETE ≠ 本仓业务实现。**storage×7 生产默认路径**已落地（#188–#190）+ live/bench；exchange 仍 scaffold + **只读 server_time**（#172）。
