# Round 08: 跨 crate 集成 — 模块 Spec 审查
...
bootstrap 接线、依赖图孤儿、组合风险。

**方法：** bootstrap Bounded* 占位 vs 真 adapter；contracts 消费面；resiliencx 未挂 adapters。

**本轮结论（一句话）：** 集成图断裂：组合根无法装配可交易应用。
...
- R8 视角「跨 crate 集成」下，未发现足以推翻「整体 NO-GO」的新证据。
