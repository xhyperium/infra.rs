...
wire/DTO 版本、deny_unknown_fields、N-1、迁移。

**方法：** canonical committed v1–v1.3；decimalx wire 非跨版本 stable；adapters 配置 env 前缀。

**本轮结论（一句话）：** L2 仅 canonical 子集明确；配置/消息 envelope 整体弱。
...
- R4 视角「兼容性」下，未发现足以推翻「整体 NO-GO」的新证据。
