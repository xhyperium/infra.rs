...
| `configx` | `crates/configx` | L1 | `.agents/ssot/configx/` | [`configx-ssot-alignment.md`](../../ssot/configx-ssot-alignment.md) | active | 32/35 | L1 内存合同 |
| `schedulex` | `crates/schedulex` | L1 | `.agents/ssot/schedulex/` | [`schedulex-ssot-alignment.md`](../../ssot/schedulex-ssot-alignment.md) | active | 32/35 | L1 registry |
| `evidence` | `crates/evidence` | L1 | `.agents/ssot/tools/evidence/` | [`evidence-ssot-alignment.md`](../../ssot/evidence-ssot-alignment.md) | active | 25/35 | L1 append |
...
| `binancex` | `crates/adapters/exchange/binance` | adapter | `.agents/ssot/adapters/exchange/binance/` | [`adapters-ssot-alignment.md`](../../ssot/adapters-ssot-alignment.md) | scaffold+mock | 24/35 | scaffold + server_time |
| `okxx` | `crates/adapters/exchange/okx` | adapter | `.agents/ssot/adapters/exchange/okx/` | [`adapters-ssot-alignment.md`](../../ssot/adapters-ssot-alignment.md) | scaffold+mock | 24/35 | scaffold + server_time |
