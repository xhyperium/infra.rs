...
> **上位**：组织 `rulesets/rust/`（P0 不可削弱）· 宪章 [§4.0](../../docs/constitution/04-code-standards.md#40-rust-全局编码规范强制上位)  
...
| 宪章 [§4.0](../../docs/constitution/04-code-standards.md#40-rust-全局编码规范强制上位) | 本仓采纳上位 + 加严入口 |
