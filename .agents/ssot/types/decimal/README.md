...
| **Code** | **`crates/types/decimal`** | 实现不在 `.agent/SSOT/` |
...
```bash
cmp .agent/SSOT/types/decimal/spec/spec.md \
    .agent/SSOT/types/decimal/spec/xhyper-decimalx-complete-spec.md
# 结构：README + 11 层目录 + evidence/ 横切
test -f .agent/SSOT/types/decimal/README.md
test -f .agent/SSOT/types/decimal/spec/spec.md
```
