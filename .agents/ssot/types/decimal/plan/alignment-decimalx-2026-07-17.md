...
| 维度 | 对齐结论 |
|------|----------|
| Active SSOT | `.agent/SSOT/types/decimal/decimalx-spec.md` 仍为实现验收权威 |
| Candidate Draft | `.agent/SSOT/types/decimal/20260717/*` · Status **Draft** · 不覆盖 Active |
...
| Todo | `.agent/SSOT/types/decimal/todo.md` · disposition 台账 |
...
| PR / Approval | [#507](https://github.com/xhyperium/xhyper.rs/pull/507) · tip-bound SSOT = **SCRATCH** `approval-readback.json` · plan/evidence 仅为 POINTER_NOT_TIP_BOUND · **≠** Goal Achieved |
