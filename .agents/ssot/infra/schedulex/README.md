...
> **当前 SSOT Spec**：[spec/spec.md](spec/spec.md) ≡ [spec/schedulex-complete-spec.md](spec/schedulex-complete-spec.md)  
...
4. 双镜像：`spec/spec.md` 与 `spec/schedulex-complete-spec.md` 须 `cmp` 同构。

## 验证

```bash
cmp .agent/SSOT/infra/schedulex/spec/spec.md \
    .agent/SSOT/infra/schedulex/spec/schedulex-complete-spec.md
