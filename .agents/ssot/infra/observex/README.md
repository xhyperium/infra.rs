...
> **状态**：`0.1.2` 进程内 sink 合同已加固；发布门禁 BLOCKED
...
| Design | [design/design.md](design/design.md) | 当前 exporter / diagnostic 设计 |
...
| **Code** | **`crates/infra/observex`** | 实现不在 `.agents/ssot/` |
...
test -f .agents/ssot/infra/observex/README.md
test -f .agents/ssot/infra/observex/spec/spec.md
```
