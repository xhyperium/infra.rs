...
> **当前 SSOT Spec**：[spec/spec.md](spec/spec.md) ≡ [spec/bootstrap-complete-spec.md](spec/bootstrap-complete-spec.md)  
...
4. 双镜像：`spec/spec.md` 与 `spec/bootstrap-complete-spec.md` 须 `cmp` 同构。

## 验证

```bash
cmp .agent/SSOT/infra/bootstrap/spec/spec.md \
    .agent/SSOT/infra/bootstrap/spec/bootstrap-complete-spec.md
