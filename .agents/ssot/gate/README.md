...
```bash
cmp .agents/ssot/gate/spec/spec.md \
    .agents/ssot/gate/spec/xhyper-gate-complete-spec.md
# 结构：README + 11 层目录 + evidence/ 横切
test -f .agents/ssot/gate/README.md
test -f .agents/ssot/gate/spec/spec.md
```
