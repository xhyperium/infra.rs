...
| terminal result | `HarnessReport` / `HarnessRunError` | 成功持 clock+records；失败保留 report+source；诊断不展开 source 对象 | HAR-03…05、10…14 | typed、可追溯 |
...
| §4 runner | HAR-01…14 | G-03、G-04、G-05、G-07 |
