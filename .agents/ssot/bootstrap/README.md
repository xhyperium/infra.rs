...
| **Code** | **`crates/infra/bootstrap`** | 实现不在 `.agent/SSOT/` |
...
```bash
cmp .agent/SSOT/infra/bootstrap/spec/spec.md \
    .agent/SSOT/infra/bootstrap/spec/xhyper-bootstrap-complete-spec.md
# 结构：README + 11 层目录 + evidence/ 横切
test -f .agent/SSOT/infra/bootstrap/README.md
test -f .agent/SSOT/infra/bootstrap/spec/spec.md
```
