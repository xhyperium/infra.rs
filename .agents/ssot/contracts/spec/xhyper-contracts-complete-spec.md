...
| Candidate | [SPEC-CONTRACTS-002](../../../draft/xhyper-contracts-complete-spec.md)（Draft，非权威，不覆盖本文） |
...
cargo check -p xhyper-contracts --all-targets
cargo clippy -p xhyper-contracts --all-targets -- -D warnings
cargo xtl lint-deps
cargo fmt -- --check
```
