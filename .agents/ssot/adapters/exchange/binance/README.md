...
| **Code** | **`crates/adapters/exchange/binance`** | 实现不在 `.agents/ssot/` |
...
test -f .agents/ssot/adapters/exchange/binance/README.md
test -f .agents/ssot/adapters/exchange/binance/spec/spec.md
```
