...
| **Code** | **`crates/adapters/exchange/okx`** | 实现不在 `.agent/SSOT/` |
...
```bash
cmp .agent/SSOT/adapters/exchange/okx/spec/spec.md \
    .agent/SSOT/adapters/exchange/okx/spec/xhyper-okx-complete-spec.md
# 结构：README + 11 层目录 + evidence/ 横切
test -f .agent/SSOT/adapters/exchange/okx/README.md
test -f .agent/SSOT/adapters/exchange/okx/spec/spec.md
```
