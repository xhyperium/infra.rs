...
| **Code** | **`crates/adapters/storage/clickhouse`** | 实现不在 `.agents/ssot/` |
...
test -f .agents/ssot/adapters/storage/clickhouse/README.md
test -f .agents/ssot/adapters/storage/clickhouse/spec/spec.md
```
