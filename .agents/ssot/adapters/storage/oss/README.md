...
| **Code** | **`crates/adapters/storage/oss`** | 实现不在 `.agents/ssot/` |
...
test -f .agents/ssot/adapters/storage/oss/README.md
test -f .agents/ssot/adapters/storage/oss/spec/spec.md
```
