...
> **状态**：`redisx **0.3.15**` Standalone P0+ + selfcheck §6.5 + live/E2E；全公开 API 已落地；package stable **未宣称**
...
| **Code** | **`crates/adapters/storage/redis`** | 实现不在 `.agents/ssot/` · **0.3.15** |
...
| Release | [release/release.md](release/release.md) | 历史候选；当前 crate version **0.3.15** |
