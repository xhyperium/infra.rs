...
| **Code** | **`crates/adapters/storage/nats`** | 实现不在 `.agent/SSOT/` |
...
```bash
cmp .agent/SSOT/adapters/storage/nats/spec/spec.md \
    .agent/SSOT/adapters/storage/nats/spec/xhyper-natsx-complete-spec.md
# 结构：README + 11 层目录 + evidence/ 横切
test -f .agent/SSOT/adapters/storage/nats/README.md
test -f .agent/SSOT/adapters/storage/nats/spec/spec.md
```
