...
| **Code** | **`crates/adapters/storage/taos`** | 实现不在 `.agents/ssot/` |
...
test -f .agents/ssot/adapters/storage/taos/README.md
test -f .agents/ssot/adapters/storage/taos/spec/spec.md
```
