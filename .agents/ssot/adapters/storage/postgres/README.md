...
| **Code** | **`crates/adapters/storage/postgres`** | 实现不在 `.agents/ssot/` |
...
test -f .agents/ssot/adapters/storage/postgres/README.md
test -f .agents/ssot/adapters/storage/postgres/spec/spec.md
```
