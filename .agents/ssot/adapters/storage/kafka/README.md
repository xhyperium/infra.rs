...
| **Code** | **`crates/adapters/storage/kafka`** | 实现不在 `.agent/SSOT/` |
...
```bash
cmp .agent/SSOT/adapters/storage/kafka/spec/spec.md \
    .agent/SSOT/adapters/storage/kafka/spec/xhyper-kafkax-complete-spec.md
# 结构：README + 11 层目录 + evidence/ 横切
test -f .agent/SSOT/adapters/storage/kafka/README.md
test -f .agent/SSOT/adapters/storage/kafka/spec/spec.md
```
