...
| 维度 | 结论 | 说明 |
|------|------|------|
| P0 生产默认路径 | **PASS** | `KafkaPool / KafkaProducer / KafkaConsumer / KafkaEventBus` |
| 离线测试 | **PASS** | `cargo test -p kafkax --all-targets`（#188–#190 CI） |
...
| DEFER | 记录 | EOS / transactional producer / schema registry / group coordinator 强依赖路径 |
