...
- 行为测试：`crates/resiliencx/src/**` 的单元测试与 `crates/resiliencx/tests/**`
...
`crates/resiliencx/src`，因此上述 `1156 / 1156` 仅是本次修复前基线。执行者按约束不运行 coverage，
...
git diff --check e0dacd95c68a09d464dda97ed1e51e129c26a3cc -- \
    crates/resiliencx crates/adapters/storage/postgres crates/adapters/storage/redis \
